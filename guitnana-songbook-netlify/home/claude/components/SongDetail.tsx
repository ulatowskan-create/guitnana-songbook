             ...
             {youtubeLink && showIframe ? (
               ...
               <div className="absolute inset-0 flex items-center justify-center">
                 <a 
                   ...
                   className="pop-button bg-[#FF0000] text-white px-8 md:px-12 py-5 md:py-8 rounded-full font-black text-xl md:text-3xl uppercase tracking-widest flex items-center gap-4 hover:scale-105 active:scale-95 transition-all shadow-[10px_10px_0px_#000]"
                 >
